...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        {
            Model.Model.UserInfo user = new Model.Model.UserInfo { userName = "Guest", passWord = "sql.123", type = "π‹¿Ì‘±" };
            ...
            var page = DAL.UserInfo.Instance.GetPage(new Model.Model.Page { pageIndex = 2, pageSize = 2 });
